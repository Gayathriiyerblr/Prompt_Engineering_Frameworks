...
## Template 2: Bug Classification(bcz many a times bug is logged with default severity not knowing the classification)
...
## Template 4: Bug Report Review(Many a times only title and one liner description of the bug is present)
...
## Template 5: Convert Notes to Bug Report(At times when testing with time constraint, we just make a notes and not a bug report)
